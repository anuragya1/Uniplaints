    ...
    <div className="bg-gradient-to-r from-orange-400  to-blue-600 min-w-96  flex justify-center items-center">
      <div className="bg-gray-800 bg-opacity-50 rounded-lg mt-2 p-8 w-4/5">
        ...
        <div className="mb-4">
          ...
          <select id="complaintType" value={complaintType} onChange={(e) => setComplaintType(e.target.value)} className="block w-full bg-gray-200 border border-gray-300 rounded px-4 py-2">
        ...
        {complaintType === 'Electricity' && (
          <div className="mb-4">
            ...
            <textarea id="electricityIssue" className="block w-full bg-gray-200 border border-gray-300 rounded px-4 py-2" placeholder="Describe the electricity issue" rows="4"></textarea>
          </div>
        )}
        ...
        {complaintType === 'Water' && (
          <div className="mb-4">
            ...
            <textarea id="WaterIssue" className="block w-full bg-gray-200 border border-gray-300 rounded px-4 py-2" placeholder="Describe the water issue" rows="4"></textarea>
            <div className='mb-4'>
              <label htmlFor='contamination' className='block text-white font-mono mb-1'>Contaminaton level:</label>
              <select id="contamination" className="block w-full bg-gray-100 border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:border-blue-500">
        ...
        {complaintType === 'Roads' && (
          <div>
            ...
            <div className="mb-4">
              ...
              <input type="text"
                id="location"
                className="block w-full bg-gray-100 border border-gray-300 rounded-md px-4 py focus:border-blue-500"
        ...
        {complaintType === 'Waste Management' && (
          <div>
            <div className="mb-4">
              ...
              <textarea id="Issue" className="block w-full bg-gray-200 border border-gray-300 rounded px-4 py-2" placeholder="Describe the issue" rows="4"></textarea>
            </div>

            <div className="mb-4">
              <label htmlFor="WasteType" className="block text-white font-mono mb-1">Type of Waste:</label>
              <select id="WasteType" className="block w-full bg-gray-200 border border-gray-300 rounded px-4 py-2">
            ...
            <div className="mb-4">
              ...
              <textarea id="Description" className="block w-full bg-gray-200 border border-gray-300 rounded px-4 py-2" placeholder="Describe the problem or complaint" rows="4"></textarea>
            </div>

            <div className="mb-4">
              <label htmlFor="DateNoticed" className="block text-white font-mono mb-1">Date Noticed:</label>
              <input type="date" id="DateNoticed" className="block w-full bg-gray-200 border border-gray-300 rounded px-4 py-2" />
            </div>

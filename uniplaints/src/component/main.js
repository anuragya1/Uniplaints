  ...
  return (
    <div className="bg-gray-900 min-h-screen text-gray-100">
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-5xl font-extrabold text-center mb-4 animate__animated animate__fadeInDown">Resolve Your Complaints Hassle-Free with Uniplaints</h1>
        <p className="text-xl text-center mb-8 animate__animated animate__fadeInUp font-light">A user-friendly platform to submit and resolve complaints efficiently, backed by personalized assistance from our dedicated team.</p>

        <div className="bg-gray-800 rounded-lg shadow-lg mx-40 p-8 mb-8 animate__animated animate__zoomIn">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-6 bg-gray-700 rounded-lg shadow delay-150 duration-300 hover:shadow-2xl animate__animated animate__fadeInLeft">
            ...
            <div className="p-6 bg-gray-700 rounded-lg shadow delay-150 duration-300 hover:shadow-2xl animate__animated animate__fadeInRight">
        ...
        <div className="bg-gray-800 rounded-lg shadow-lg p-8 delay-150  mx-40 duration-300 hover:shadow-2xl animate__animated animate__zoomIn">
      ...
      <div className='delay-150 shadow-lg rounded-lg mb-5 hover:shadow-2xl duration-300 px-16 py-14 mx-20 w-auto text-4xl font-bold flex justify-center flex-wrap bg-gray-800 animate__animated animate__fadeInUp'>
      ...
      <div className='flex animate__animated animate__zoomIn mx-52 '>
        <div id="content" className='delay-150 shadow rounded-lg duration-300 hover:shadow-2xl text-xl font-semibold w-1/2 mb-4 px-20 py-14 mx-10 my-10 bg-gray-800 flex-wrap'>
        ...
        <div id="values" className=' mr-7 delay-150 shadow rounded-lg text-4xl duration-300 hover:shadow-2xl font-semibold w-1/2 px-16 mb-4 justify-center mx-10 py-14 my-10 bg-gray-800 flex-wrap'>
